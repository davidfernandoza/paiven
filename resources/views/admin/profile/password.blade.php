					...
					<form action="/control/perfil/password" method="POST" autocomplete="off">
						...
						@if (!Session::has('password_request'))
							<div class="form-group @error('current-password') has-error  @enderror">
								...
								<input id="password" type="password" class="form-control" name="current-password" required  title="Password Actual" placeholder="Password Actual" min="8" max="64">
								...
								<div class="form-group @error('password') has-error  @enderror">
									...
									<input id="password" type="password" class="form-control" name="password" required  title="Password Nuevo" placeholder="Password Nuevo" min="8" max="64">
